		...
		return (
			<div className="top-header">
				<div className="top-header-inner">
					{this.props.collapse.isCollapsed?<MenuUnfoldOutlined  onClick={this.toggle}/>:<MenuFoldOutlined onClick={this.toggle}/>}
					<div className="header-right">
						<div className="full-screen">
							<FullScreen style={{ fontSize: '21px', cursor: 'pointer' }}/>
						</div>
						...
						<div className="news-wrap">
							<Badge>
								<MessageOutlined style={{ fontSize: '21px', cursor: 'pointer' }} onClick={this.toNews}/>
							</Badge>
						</div>
